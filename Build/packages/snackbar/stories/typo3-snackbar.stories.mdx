...
## `typo3-remove-snackbar` event
The typo3-snackbar element can be removed via the `typo3-remove-snackbar` custom event (which can be dispatch by any other elements).

### Usage of `typo3-remove-snackbar` custom events
```javascript

...
<Preview>
    ...
    {html`
      ...
      <typo3-button color="primary" onclick='window.dispatchEvent(new CustomEvent("typo3-add-snackbar", {detail: {dismissible: true, message: "test"}}));'>
        Open Snackbar
      </typo3-button>
      <typo3-button color="secondary" onclick='window.dispatchEvent(new CustomEvent("typo3-add-snackbar", {detail: {dismissible: false, message: "test", }}));'>
        Open Snackbar without Button
      </typo3-button>
      <typo3-button color="info" onclick='window.dispatchEvent(new CustomEvent("typo3-add-snackbar", {detail: {dismissible: true, message: "test", duration: null }}));'>
        Open Snackbar without auto hide
      </typo3-button>
    `}
    </Story>
</Preview>
...
| `variant`     | String  | Name of variant to use                                 | 'default', 'success', 'warning', 'error', 'info' | 'default' |

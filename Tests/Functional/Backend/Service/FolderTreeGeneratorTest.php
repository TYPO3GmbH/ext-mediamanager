    ...
    public function it_can_generate_folder_tree(): void
    {
        ...
        self::assertEquals([
            [
                ...
                'siblingsPosition' => 0,
                'hasChildren' => true,
                'folderUrl' => '/typo3/ajax/mediamanager/folder/fetch-data?token=dummyToken&identifier=1%3A%2Ftest-folder',
            ...
            [
                ...
                'siblingsPosition' => 2,
                'hasChildren' => false,
                'folderUrl' => '/typo3/ajax/mediamanager/folder/fetch-data?token=dummyToken&identifier=1%3A%2Ftest-folder-sub',
